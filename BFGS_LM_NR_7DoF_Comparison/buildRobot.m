...
arm0.Joint = jnt0;
addBody(robot,arm0,'base'); % add arm 1 to base\
...
arm1.Joint = jnt1;
addBody(robot,arm1,'arm0'); % add arm 1 to base\
...
arm2.Joint = jnt2;
addBody(robot,arm2,'arm1'); % add arm 1 to base
...
arm3.Joint = jnt3;
addBody(robot,arm3,'arm2'); % add arm 1 to base
...
arm4.Joint = jnt4;
addBody(robot,arm4,'arm3'); % add arm 1 to base
...
arm5.Joint = jnt5;
addBody(robot,arm5,'arm4'); % add arm 1 to base
...
arm6.Joint = jnt6;
addBody(robot,arm6,'arm5'); % add arm 1 to base
